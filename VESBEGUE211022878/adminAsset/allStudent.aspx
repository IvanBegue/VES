<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="allStudent.aspx.cs" Inherits="VESBEGUE211022878.adminAsset.allStudent" %>
                        ...
                        <div class="table-responsive">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <asp:Repeater ID="lovStudent" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    <td class="text-capitalize"><%# Eval("firstname") %></td>
                                                    <td class="text-capitalize"><%# Eval("lastname") %></td>
                                                    <td><%# Eval("email") %></td>
                                                    <td><%# String.Format("{0:dd/MM/yyyy}", Eval("dateregister")) %></td>
